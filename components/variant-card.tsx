        ...
        <div className="absolute top-2 right-2 flex gap-1">
          <button onClick={handleThumbsUp}
            className={`w-7 h-7 rounded-md text-xs flex items-center justify-center transition-all ${
              feedback === 'good' ? 'bg-[#22c55e] text-white' : 'bg-black/70 backdrop-blur-sm text-white hover:bg-[#22c55e]'
            }`}
          ...
          <button onClick={handleThumbsDown}
            className={`w-7 h-7 rounded-md text-xs flex items-center justify-center transition-all ${
              feedback === 'bad' ? 'bg-red-600 text-white' : 'bg-black/70 backdrop-blur-sm text-white hover:bg-red-600'
            }`}
            title="Schlecht - Feedback geben">
            ↓
          </button>
          <button onClick={onRegenerate}
            className="w-7 h-7 bg-black/70 backdrop-blur-sm rounded-md text-white text-xs flex items-center justify-center hover:bg-[#00D4FF] hover:text-black transition-all"
